		...
		<div class="layer-settings-toolbar" id="rs-style-content-wrapper" style="">
			...
			<div style="border-top:1px solid #ddd;">
				...
				<span class="rs-layer-toolbar-box" style="padding-right:0px;">
					...
					<input type="text" class="rs-staticcustomstylechange text-sidebar rs-layer-input-field tipsy_enabled_top" title="<?php _e("Font Family",REVSLIDER_TEXTDOMAIN); ?>" style="width:185px" type="text" name="css_font-family" value="" autocomplete="off"> <?php /* Provider:  -   id="font_family" */ ?>
			...
			<span class="rs-layer-toolbar-box" id="layer_static_wrapper" <?php echo ($isTemplate == "true") ? ' style="display: none;"' : ''; ?>>
				...
				<select id="layer_static_start" name="static_start">
					...
					if(!empty($arrSlideNames)){
						...
						/* Provider:  - ?><option value="last"><?php _e('Last Slide', REVSLIDER_TEXTDOMAIN); ?></option><?php*/
					}else{
						?>
						<option value="-1">-1</option>
						<?php
