...
<?php endif; ?>
	...
	<div class="dt-dummy-controls-block">
		...
		<div class="dt-dummy-field">
			<label><input type="checkbox" name="all"<?php echo $checkbox_status; ?> value="1" /><?php esc_html_e( 'Import the entire content', 'dt-dummy' ); ?></label><span class="dt-dummy-checkbox-desc"><?php esc_html_e( '(Note that this will automatically switch your active Menu and Homepage.)', 'dt-dummy' ); ?></span>
		</div>
