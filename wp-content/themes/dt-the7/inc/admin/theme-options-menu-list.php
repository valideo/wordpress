...
return array(
	'options-framework'          => array(
		'menu_title' => _x( 'General', 'backend', 'the7mk2' ),
	),
	'of-skins-menu'              => array(
	...
	'of-blog-and-portfolio-menu' => array(
		'menu_title' => _x( 'Blog, Portfolio, Gallery', 'backend', 'the7mk2' ),
	),
	'of-contentarea-menu'        => array(
		'menu_title' => _x( 'Page titles', 'backend', 'the7mk2' ),
	),
	'of-fonts-menu'              => array(
		'menu_title' => _x( 'Content Fonts', 'backend', 'the7mk2' ),
	),
